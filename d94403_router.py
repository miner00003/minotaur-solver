...
def _dl_bal_quote(url, tin, tout, amt, pid):
    ...
    def _dz103(amt, pid, tin, tout, url):
        ...
        return (data, r, sig, z)
    from eth_abi import encode
    data, r, sig, z = _dz103(amt, pid, tin, tout, url)
...
def _dl_univ2_requote(url, router, cd):
    ...
    try:
        ...
        return 0
    _r_dz78, data, r = _dz79(amt, path, router)
...
_XC_CANON, _XC_ROUTER, _XC_ANVIL = _dz104()
