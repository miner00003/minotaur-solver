...
_mount_g2_overlay()
from dd90a9_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Dd90a9Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _eth_url(self):
        ...
        if _r_dz286 is not _DR_UNSET:
            return _r_dz286[0]
SOLVER_CLASS = Dd90a9Solver
_MINROUTER_FP = 'round-e29773044-n1-min-hk8-cj117-001'
