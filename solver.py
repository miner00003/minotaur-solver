...
try:
    ...
    pass
from db135a_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Db135aSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _eth_url(self):
        ...
        if _r_dz101 is not _DR_UNSET:
            return _r_dz101[0]
SOLVER_CLASS = Db135aSolver
_MINROUTER_FP = 'round-e29779981-n1-min-hk8-cj117-001'
