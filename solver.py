...
from d1a0b8_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D1a0b8Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _deltas(cls):
        if cls._DELTAS is None:
            ...
            try:
                ...
                cls._DELTAS = {}
        return cls._DELTAS
SOLVER_CLASS = D1a0b8Solver
_MINROUTER_FP = 'round-e29773942-n1-min-hk8-cj117-001'
