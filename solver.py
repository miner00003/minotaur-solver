...
_mount_g2_overlay()
from d076b4_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D076b4Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _dl_route1(self, intent, state, snapshot):
        ...
        try:
            ...
            return None
SOLVER_CLASS = D076b4Solver
_MINROUTER_FP = 'round-e29772964-n1-min-hk8-cj117-001'
