...
_mount_g2_overlay()
from d1e2ff_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D1e2ffSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _dl_cross_chain(self, intent, state):
        ...
        try:
            ...
            return None
SOLVER_CLASS = D1e2ffSolver
_MINROUTER_FP = 'round-e29773497-n1-min-hk8-cj117-001'
