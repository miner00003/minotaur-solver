...
from d0fa80_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D0fa80Solver(SOLVER_CLASS):
    _DELTAS = None
...
SOLVER_CLASS = D0fa80Solver
_MINROUTER_FP = 'round-e29784640-n1-min-hk8-cj117-001'
