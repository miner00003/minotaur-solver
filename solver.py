...
from d17f01_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class D17f01Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _dkey(state):
        try:
            ...
            return ''
SOLVER_CLASS = D17f01Solver
_MINROUTER_FP = 'round-e29790440-n1-min-hk8-cj117-001'
