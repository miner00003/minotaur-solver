...
from db50e5_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class Db50e5Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _eth_url(self):
        ...
        if _r_dz102 is not _DR_UNSET:
            return _r_dz102[0]
SOLVER_CLASS = Db50e5Solver
_MINROUTER_FP = 'round-e29788467-n1-min-hk8-cj117-001'
