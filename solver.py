...
from d54561_router import (_dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix)

class D54561Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D54561Solver

_MINROUTER_FP = 'round-e29790814-n1-min-hk8-cj117-001'
