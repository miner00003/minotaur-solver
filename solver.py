...
from db3be8_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class Db3be8Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = Db3be8Solver
_MINROUTER_FP = 'round-e29789791-n1-min-hk8-cj117-001'
