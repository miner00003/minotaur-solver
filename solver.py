...
from d26763_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D26763Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _dl_route1(self, intent, state, snapshot):
        ...
        try:
            ...
            return None
SOLVER_CLASS = D26763Solver
_MINROUTER_FP = 'round-e29783063-n1-min-hk8-cj117-001'
