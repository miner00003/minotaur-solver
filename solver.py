...
_mount_yield_cover()
from d447ff_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix, _dl_census_ix, _dl_census_cover_impl, _dl_census_base_impl, _dl_census_base_ix

class D447ffSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
...
SOLVER_CLASS = D447ffSolver
_MINROUTER_FP = 'round-e29794484-n1-min-hk8-cj117-001'
