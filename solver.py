...
from db4a3d_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class Db4a3dSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _dl_snapshot_route(self, snapshot, tin, tout):
        ...
        for _addr, st in ps.items():
            try:
                ...
                continue
        return best
SOLVER_CLASS = Db4a3dSolver
_MINROUTER_FP = 'round-e29791727-n1-min-hk8-cj117-001'
