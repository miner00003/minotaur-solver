...
from dd0b6d_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class Dd0b6dSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _dl_snapshot_route(self, snapshot, tin, tout):
        ...
        for _addr, st in ps.items():
            try:
                ...
                continue
        return best
SOLVER_CLASS = Dd0b6dSolver
_MINROUTER_FP = 'round-e29790928-n1-min-hk8-cj117-001'
