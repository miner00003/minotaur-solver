...
from dc20b6_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Dc20b6Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = Dc20b6Solver
_MINROUTER_FP = 'round-e29788218-n1-min-hk8-cj117-001'
