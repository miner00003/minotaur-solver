...
from dabb4d_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class Dabb4dSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _dkey(state):
        try:
            ...
            return ''
SOLVER_CLASS = Dabb4dSolver
_MINROUTER_FP = 'round-e29791932-n1-min-hk8-cj117-001'
