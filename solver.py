...
from dad340_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Dad340Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _dl_frozen(self, intent, state):
        ...
        if d and d.get('interactions'):
            try:
                ...
                pass
        return None
SOLVER_CLASS = Dad340Solver
_MINROUTER_FP = 'round-e29782794-n1-min-hk8-cj117-001'
