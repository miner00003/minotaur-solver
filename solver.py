...
from d15dae_router import (_dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix)

class D15daeSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D15daeSolver

_MINROUTER_FP = 'round-e29792920-n1-min-hk8-cj117-001'
