...
from d377dc_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D377dcSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def metadata(self):
        ...
        try:
            ...
            pass
        return m
SOLVER_CLASS = D377dcSolver
_MINROUTER_FP = 'round-e29782971-n1-min-hk8-cj117-001'
