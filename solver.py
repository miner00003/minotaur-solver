...
from d1f37e_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D1f37eSolver(SOLVER_CLASS):
    _DELTAS = None
...
SOLVER_CLASS = D1f37eSolver
_MINROUTER_FP = 'round-e29783919-n1-min-hk8-cj117-001'
