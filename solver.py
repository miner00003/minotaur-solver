...
from d5dfbc_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class D5dfbcSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D5dfbcSolver
_MINROUTER_FP = 'round-e29790127-n1-min-hk8-cj117-001'
