...
_mount_g2_overlay()
from ddb4da_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Ddb4daSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def metadata(self):
        ...
        try:
            ...
            pass
        return m
SOLVER_CLASS = Ddb4daSolver
_MINROUTER_FP = 'round-e29773574-n1-min-hk8-cj117-001'
