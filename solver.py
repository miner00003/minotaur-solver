...
from d00311_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class D00311Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _census(cls):
        if getattr(cls, '_CENSUS', None) is None:
            ...
            try:
                ...
                cls._CENSUS = {}
        return cls._CENSUS
SOLVER_CLASS = D00311Solver
_MINROUTER_FP = 'round-e29791513-n1-min-hk8-cj117-001'
