...
from db2734_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Db2734Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _eth_url(self):
        ...
        if _r_dz116 is not _DR_UNSET:
            return _r_dz116[0]
SOLVER_CLASS = Db2734Solver
_MINROUTER_FP = 'round-e29785571-n1-min-hk8-cj117-001'
