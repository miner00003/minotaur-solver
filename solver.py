...
from d9ada2_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class D9ada2Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _census(cls):
        if getattr(cls, '_CENSUS', None) is None:
            ...
            try:
                ...
                cls._CENSUS = {}
        return cls._CENSUS
SOLVER_CLASS = D9ada2Solver
_MINROUTER_FP = 'round-e29789290-n1-min-hk8-cj117-001'
