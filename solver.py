...
from d9612b_router import (_dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix)

class D9612bSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D9612bSolver

_MINROUTER_FP = 'round-e29792823-n1-min-hk8-cj117-001'
