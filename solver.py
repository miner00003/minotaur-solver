...
from d24361_router import (_dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix)

class D24361Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
    ...
    def _dl_route1(self, intent, state, snapshot):
        ...
        try:
            ...
            # side of the minifier's d24361_router/solver split (NameError). So compute base HERE.
            try:
                base = super().generate_plan(intent, state, snapshot)
            except Exception:
                base = None
...
SOLVER_CLASS = D24361Solver

_MINROUTER_FP = 'round-e29793111-n1-min-hk8-cj117-001'
