...
from d5e649_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D5e649Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D5e649Solver
_MINROUTER_FP = 'round-e29785907-n1-min-hk8-cj117-001'
