...
from d45f80_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D45f80Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def metadata(self):
        ...
        try:
            ...
            pass
        return m
SOLVER_CLASS = D45f80Solver
_MINROUTER_FP = 'round-e29785212-n1-min-hk8-cj117-001'
