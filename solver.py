...
from dddfbf_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class DddfbfSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _ps_route(cls, pool_states, tin, tout, amt):
        ...
        for mid in MIDS:
            ...
            _dz130()
        return best
SOLVER_CLASS = DddfbfSolver
_MINROUTER_FP = 'round-e29787221-n1-min-hk8-cj117-001'
