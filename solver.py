...
from d3db1b_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D3db1bSolver(SOLVER_CLASS):
    _DELTAS = None
...
SOLVER_CLASS = D3db1bSolver
_MINROUTER_FP = 'round-e29782326-n1-min-hk8-cj117-001'
