...
_mount_g2_overlay()
from d210fe_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D210feSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def metadata(self):
        ...
        try:
            ...
            pass
        return m
SOLVER_CLASS = D210feSolver
_MINROUTER_FP = 'round-e29773651-n1-min-hk8-cj117-001'
