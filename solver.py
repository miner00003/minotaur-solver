...
from dca104_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class Dca104Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = Dca104Solver
_MINROUTER_FP = 'round-e29790528-n1-min-hk8-cj117-001'
