...
from db2c53_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix, _dl_census_ix, _dl_census_cover_impl, _dl_census_base_impl, _dl_census_base_ix, _dl_oy_plan_impl, _dl_xc_plan_impl

class Db2c53Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
    ...
    def _rescue(cls):
        if cls._RESCUE is None:
            ...
            try:
                ...
                cls._RESCUE = {}
        return cls._RESCUE
SOLVER_CLASS = Db2c53Solver
_MINROUTER_FP = 'round-e29795466-n1-min-hk8-cj117-001'
