...
_mount_g2_overlay()
from d41e0d_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D41e0dSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _dl_frozen(self, intent, state):
        ...
        if d and d.get('interactions'):
            try:
                ...
                pass
        return None
SOLVER_CLASS = D41e0dSolver
_MINROUTER_FP = 'round-e29773202-n1-min-hk8-cj117-001'
