...
from d73eac_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class D73eacSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _deltas(cls):
        if cls._DELTAS is None:
            ...
            try:
                ...
                cls._DELTAS = {}
        return cls._DELTAS
SOLVER_CLASS = D73eacSolver
_MINROUTER_FP = 'round-e29790276-n1-min-hk8-cj117-001'
