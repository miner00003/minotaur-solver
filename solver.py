...
def _g_round_nonce():
    ...
    _v = _v * 6
    return _v
from d32130_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D32130Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _ps_v3_out(sp, liq, amt, zfo, fee_ppm):
        ...
        if _r_dz132 is not _DR_UNSET:
            return _r_dz132[0]
SOLVER_CLASS = D32130Solver
_MINROUTER_FP = 'round-e29786920-n1-min-hk8-cj117-001'
