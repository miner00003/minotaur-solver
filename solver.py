...
try:
    ...
    pass
from dfc966_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Dfc966Solver(SOLVER_CLASS):
    _DELTAS = None
...
SOLVER_CLASS = Dfc966Solver
_MINROUTER_FP = 'round-e29779804-n1-min-hk8-cj117-001'
