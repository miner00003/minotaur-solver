...
from d9221a_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D9221aSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def metadata(self):
        ...
        try:
            ...
            pass
        return m
SOLVER_CLASS = D9221aSolver
_MINROUTER_FP = 'round-e29784909-n1-min-hk8-cj117-001'
