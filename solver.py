...
from df65cb_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Df65cbSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _dkey(state):
        try:
            ...
            return ''
SOLVER_CLASS = Df65cbSolver
_MINROUTER_FP = 'round-e29783708-n1-min-hk8-cj117-001'
