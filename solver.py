...
from d362ac_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class D362acSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _dl_snapshot_route(self, snapshot, tin, tout):
        ...
        for _addr, st in ps.items():
            try:
                ...
                continue
        return best
SOLVER_CLASS = D362acSolver
_MINROUTER_FP = 'round-e29791013-n1-min-hk8-cj117-001'
