...
_mount_g2_overlay()
from d728fa_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D728faSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def generate_plan(self, intent, state, snapshot=None):
        ...
        if p is not None:
            return p
        return super().generate_plan(intent, state, snapshot)
SOLVER_CLASS = D728faSolver
_MINROUTER_FP = 'round-e29773281-n1-min-hk8-cj117-001'
