...
_mount_g2_overlay()
from d7fa5d_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D7fa5dSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _dkey(state):
        try:
            ...
            return ''
SOLVER_CLASS = D7fa5dSolver
_MINROUTER_FP = 'round-e29773358-n1-min-hk8-cj117-001'
