...
from d99a95_router import (_dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix)

class D99a95Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D99a95Solver

_MINROUTER_FP = 'round-e29792544-n1-min-hk8-cj117-001'
