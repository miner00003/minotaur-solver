...
from df6667_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class Df6667Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _dkey(state):
        try:
            ...
            return ''
SOLVER_CLASS = Df6667Solver
_MINROUTER_FP = 'round-e29789027-n1-min-hk8-cj117-001'
