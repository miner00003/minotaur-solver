...
_mount_g2_overlay()
from dfe529_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Dfe529Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def metadata(self):
        ...
        try:
            ...
            pass
        return m
SOLVER_CLASS = Dfe529Solver
_MINROUTER_FP = 'round-e29772807-n1-min-hk8-cj117-001'
