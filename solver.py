...
from dab420_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Dab420Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _dkey(state):
        try:
            ...
            return ''
SOLVER_CLASS = Dab420Solver
_MINROUTER_FP = 'round-e29788062-n1-min-hk8-cj117-001'
