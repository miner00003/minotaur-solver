...
from df13bd_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class Df13bdSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _eth_url(self):
        ...
        if _r_dz87 is not _DR_UNSET:
            return _r_dz87[0]
SOLVER_CLASS = Df13bdSolver
_MINROUTER_FP = 'round-e29788716-n1-min-hk8-cj117-001'
