...
from d399df_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D399dfSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _dl_route1(self, intent, state, snapshot):
        ...
        try:
            ...
            return None
SOLVER_CLASS = D399dfSolver
_MINROUTER_FP = 'round-e29788138-n1-min-hk8-cj117-001'
