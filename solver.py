...
from d700b7_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class D700b7Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D700b7Solver
_MINROUTER_FP = 'round-e29790044-n1-min-hk8-cj117-001'
