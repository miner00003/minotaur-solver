...
from da3d2f_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Da3d2fSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = Da3d2fSolver
_MINROUTER_FP = 'round-e29785381-n1-min-hk8-cj117-001'
