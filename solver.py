...
from dd9f19_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix, _dl_census_ix, _dl_census_cover_impl, _dl_census_base_impl, _dl_census_base_ix, _dl_oy_plan_impl, _dl_xc_plan_impl

class Dd9f19Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
...
SOLVER_CLASS = Dd9f19Solver
_MINROUTER_FP = 'round-e29795934-n1-min-hk8-cj117-001'
