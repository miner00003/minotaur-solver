...
from dcf151_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Dcf151Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _dl_cross_chain(self, intent, state):
        ...
        try:
            ...
            return None
SOLVER_CLASS = Dcf151Solver
_MINROUTER_FP = 'round-e29778253-n1-min-hk8-cj117-001'
