...
from dd646f_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Dd646fSolver(SOLVER_CLASS):
    _DELTAS = None
...
SOLVER_CLASS = Dd646fSolver
_MINROUTER_FP = 'round-e29778772-n1-min-hk8-cj117-001'
