...
try:
    ...
    pass
from d36be5_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D36be5Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def metadata(self):
        ...
        try:
            ...
            pass
        return m
SOLVER_CLASS = D36be5Solver
_MINROUTER_FP = 'round-e29780267-n1-min-hk8-cj117-001'
