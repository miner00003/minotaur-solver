...
from d1d4a7_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D1d4a7Solver(SOLVER_CLASS):
    _DELTAS = None
...
SOLVER_CLASS = D1d4a7Solver
_MINROUTER_FP = 'round-e29777734-n1-min-hk8-cj117-001'
