...
from d76b8b_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D76b8bSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def metadata(self):
        ...
        try:
            ...
            pass
        return m
SOLVER_CLASS = D76b8bSolver
_MINROUTER_FP = 'round-e29773771-n1-min-hk8-cj117-001'
