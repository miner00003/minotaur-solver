...
from da09f5_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Da09f5Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _rescue(cls):
        if cls._RESCUE is None:
            ...
            try:
                ...
                cls._RESCUE = {}
        return cls._RESCUE
SOLVER_CLASS = Da09f5Solver
_MINROUTER_FP = 'round-e29785803-n1-min-hk8-cj117-001'
