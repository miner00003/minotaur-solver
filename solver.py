...
from ddb178_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class Ddb178Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _dl_route1(self, intent, state, snapshot):
        ...
        try:
            ...
            return None
SOLVER_CLASS = Ddb178Solver
_MINROUTER_FP = 'round-e29789959-n1-min-hk8-cj117-001'
