...
from debfa7_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class Debfa7Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _eth_url(self):
        ...
        if _r_dz89 is not _DR_UNSET:
            return _r_dz89[0]
SOLVER_CLASS = Debfa7Solver
_MINROUTER_FP = 'round-e29789456-n1-min-hk8-cj117-001'
