...
from df15f6_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Df15f6Solver(SOLVER_CLASS):
    _DELTAS = None
...
SOLVER_CLASS = Df15f6Solver
_MINROUTER_FP = 'round-e29783380-n1-min-hk8-cj117-001'
