...
from d01fb1_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D01fb1Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def metadata(self):
        ...
        try:
            ...
            pass
        return m
SOLVER_CLASS = D01fb1Solver
_MINROUTER_FP = 'round-e29785477-n1-min-hk8-cj117-001'
