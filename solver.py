...
from d7a2fc_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix, _dl_census_ix, _dl_census_cover_impl, _dl_census_base_impl, _dl_census_base_ix, _dl_oy_plan_impl

class D7a2fcSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
    ...
    def _dkey(state):
        try:
            ...
            return ''
SOLVER_CLASS = D7a2fcSolver
_MINROUTER_FP = 'round-e29795142-n1-min-hk8-cj117-001'
