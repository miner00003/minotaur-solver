...
from dbfc2b_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Dbfc2bSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = Dbfc2bSolver
_MINROUTER_FP = 'round-e29786005-n1-min-hk8-cj117-001'
