...
from dd5001_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class Dd5001Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _deltas(cls):
        if cls._DELTAS is None:
            ...
            try:
                ...
                cls._DELTAS = {}
        return cls._DELTAS
SOLVER_CLASS = Dd5001Solver
_MINROUTER_FP = 'round-e29788940-n1-min-hk8-cj117-001'
