...
from d7a21d_router import (_dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix)

class D7a21dSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D7a21dSolver

_MINROUTER_FP = 'round-e29792633-n1-min-hk8-cj117-001'
