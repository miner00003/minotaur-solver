...
from d15b75_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix, _dl_census_ix, _dl_census_cover_impl, _dl_census_base_impl, _dl_census_base_ix, _dl_oy_plan_impl, _dl_xc_plan_impl

class D15b75Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
    ...
    def _eth_url(self):
        ...
        if _r_dz104 is not _DR_UNSET:
            return _r_dz104[0]
SOLVER_CLASS = D15b75Solver
_MINROUTER_FP = 'round-e29795751-n1-min-hk8-cj117-001'
