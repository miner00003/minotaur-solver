...
try:
    ...
    pass
from dd7475_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Dd7475Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _eth_url(self):
        ...
        if _r_dz102 is not _DR_UNSET:
            return _r_dz102[0]
SOLVER_CLASS = Dd7475Solver
_MINROUTER_FP = 'round-e29780351-n1-min-hk8-cj117-001'
