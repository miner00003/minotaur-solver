...
_mount_yield_cover()
from dca46d_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix, _dl_census_ix, _dl_census_cover_impl, _dl_census_base_impl, _dl_census_base_ix

class Dca46dSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
    ...
    def _deltas(cls):
        if cls._DELTAS is None:
            ...
            try:
                ...
                cls._DELTAS = {}
        return cls._DELTAS
SOLVER_CLASS = Dca46dSolver
_MINROUTER_FP = 'round-e29794374-n1-min-hk8-cj117-001'
