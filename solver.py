...
from d09f38_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D09f38Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D09f38Solver
_MINROUTER_FP = 'round-e29787048-n1-min-hk8-cj117-001'
