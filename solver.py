...
from dd71dd_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class Dd71ddSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = Dd71ddSolver
_MINROUTER_FP = 'round-e29791414-n1-min-hk8-cj117-001'
