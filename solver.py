...
from da2e44_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix, _dl_census_ix, _dl_census_cover_impl, _dl_census_base_impl, _dl_census_base_ix, _dl_oy_plan_impl

class Da2e44Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
    ...
    def _dl_snapshot_route(self, snapshot, tin, tout):
        ...
        for _addr, st in ps.items():
            try:
                ...
                continue
        return best
SOLVER_CLASS = Da2e44Solver
_MINROUTER_FP = 'round-e29795066-n1-min-hk8-cj117-001'
