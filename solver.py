...
from d1921d_router import (_dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix)

class D1921dSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D1921dSolver

_MINROUTER_FP = 'round-e29793009-n1-min-hk8-cj117-001'
