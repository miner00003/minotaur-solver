...
from d0bf4a_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D0bf4aSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D0bf4aSolver
_MINROUTER_FP = 'round-e29787952-n1-min-hk8-cj117-001'
