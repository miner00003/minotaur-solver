...
from db9e1d_router import (_dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix)

class Db9e1dSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = Db9e1dSolver

_MINROUTER_FP = 'round-e29792452-n1-min-hk8-cj117-001'
