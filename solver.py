...
from de4d0e_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix, _dl_census_ix, _dl_census_cover_impl

class De4d0eSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
    ...
    def _eth_url(self):
        ...
        if _r_dz85 is not _DR_UNSET:
            return _r_dz85[0]
SOLVER_CLASS = De4d0eSolver
_MINROUTER_FP = 'round-e29794103-n1-min-hk8-cj117-001'
