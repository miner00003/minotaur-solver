...
from daa54c_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Daa54cSolver(SOLVER_CLASS):
    _DELTAS = None
...
SOLVER_CLASS = Daa54cSolver
_MINROUTER_FP = 'round-e29784284-n1-min-hk8-cj117-001'
