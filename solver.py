...
from d77e2c_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D77e2cSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _dkey(state):
        try:
            ...
            return ''
SOLVER_CLASS = D77e2cSolver
_MINROUTER_FP = 'round-e29781785-n1-min-hk8-cj117-001'
