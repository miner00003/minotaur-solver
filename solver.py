...
from dda72a_router import (_dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override)

class Dda72aSolver(SOLVER_CLASS):
    _DELTAS = None
...
SOLVER_CLASS = Dda72aSolver

_MINROUTER_FP = 'round-e29779347-n1-min-hk8-cj117-001'
_MINROUTER_NAME = 'leanrtr'
_MINROUTER_VER = '1.1.0'
