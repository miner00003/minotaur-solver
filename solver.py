...
from db85d5_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Db85d5Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def metadata(self):
        ...
        try:
            ...
            pass
        return m
SOLVER_CLASS = Db85d5Solver
_MINROUTER_FP = 'round-e29783150-n1-min-hk8-cj117-001'
