...
from ddeba4_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Ddeba4Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = Ddeba4Solver
_MINROUTER_FP = 'round-e29785293-n1-min-hk8-cj117-001'
