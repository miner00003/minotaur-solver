...
from d09179_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix, _dl_census_ix, _dl_census_cover_impl, _dl_census_base_impl, _dl_census_base_ix, _dl_oy_plan_impl, _dl_xc_plan_impl

class D09179Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
    ...
    def _ovr(cls):
        if cls._OVR is None:
            ...
            try:
                ...
                cls._OVR = set()
        return cls._OVR
SOLVER_CLASS = D09179Solver
_MINROUTER_FP = 'round-e29795657-n1-min-hk8-cj117-001'
