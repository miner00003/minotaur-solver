...
from d08f05_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D08f05Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _eth_url(self):
        ...
        if _r_dz111 is not _DR_UNSET:
            return _r_dz111[0]
SOLVER_CLASS = D08f05Solver
_MINROUTER_FP = 'round-e29783583-n1-min-hk8-cj117-001'
