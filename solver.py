...
_mount_yield_cover()
from d88ad2_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix, _dl_census_ix, _dl_census_cover_impl, _dl_census_base_impl, _dl_census_base_ix

class D88ad2Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
...
SOLVER_CLASS = D88ad2Solver
_MINROUTER_FP = 'round-e29794704-n1-min-hk8-cj117-001'
