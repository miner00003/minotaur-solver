...
from d8e178_router import (_dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix)

class D8e178Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D8e178Solver

_MINROUTER_FP = 'round-e29792734-n1-min-hk8-cj117-001'
