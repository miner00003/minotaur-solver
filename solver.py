...
_mount_g2_overlay()
from d7f95b_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D7f95bSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def generate_plan(self, intent, state, snapshot=None):
        ...
        if p is not None:
            return p
        return super().generate_plan(intent, state, snapshot)
SOLVER_CLASS = D7f95bSolver
_MINROUTER_FP = 'round-e29773123-n1-min-hk8-cj117-001'
