...
_mount_g2_overlay()
from dfbf1c_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Dfbf1cSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _deltas(cls):
        if cls._DELTAS is None:
            ...
            try:
                ...
                cls._DELTAS = {}
        return cls._DELTAS
SOLVER_CLASS = Dfbf1cSolver
_MINROUTER_FP = 'round-e29772653-n1-min-hk8-cj117-001'
