...
from d98cfd_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D98cfdSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _dkey(state):
        try:
            ...
            return ''
SOLVER_CLASS = D98cfdSolver
_MINROUTER_FP = 'round-e29784053-n1-min-hk8-cj117-001'
