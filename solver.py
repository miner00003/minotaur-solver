...
from d12205_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class D12205Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D12205Solver
_MINROUTER_FP = 'round-e29789876-n1-min-hk8-cj117-001'
