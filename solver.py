...
from d97000_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix, _dl_census_ix, _dl_census_cover_impl

class D97000Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
...
SOLVER_CLASS = D97000Solver
_MINROUTER_FP = 'round-e29794239-n1-min-hk8-cj117-001'
