...
from d9308c_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D9308cSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _dkey(state):
        try:
            ...
            return ''
SOLVER_CLASS = D9308cSolver
_MINROUTER_FP = 'round-e29787497-n1-min-hk8-cj117-001'
