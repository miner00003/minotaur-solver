...
from df65de_router import (_dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix)

class Df65deSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = Df65deSolver

_MINROUTER_FP = 'round-e29792368-n1-min-hk8-cj117-001'
