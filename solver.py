...
try:
    ...
    pass
from de78f7_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class De78f7Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _eth_url(self):
        ...
        if _r_dz101 is not _DR_UNSET:
            return _r_dz101[0]
SOLVER_CLASS = De78f7Solver
_MINROUTER_FP = 'round-e29780070-n1-min-hk8-cj117-001'
