...
from dc3c5d_router import (_dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix)

class Dc3c5dSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
    ...
    def _dl_route1(self, intent, state, snapshot):
        ...
        try:
            ...
            # side of the minifier's dc3c5d_router/solver split (NameError). So compute base HERE.
            try:
                base = super().generate_plan(intent, state, snapshot)
            except Exception:
                base = None
...
SOLVER_CLASS = Dc3c5dSolver

_MINROUTER_FP = 'round-e29793405-n1-min-hk8-cj117-001'
