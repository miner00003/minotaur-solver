...
_mount_g2_overlay()
from da1cb4_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class Da1cb4Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _dkey(state):
        try:
            ...
            return ''
SOLVER_CLASS = Da1cb4Solver
_MINROUTER_FP = 'round-e29772576-n1-min-hk8-cj117-001'
