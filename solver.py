...
from d18dfc_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class D18dfcSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
...
SOLVER_CLASS = D18dfcSolver
_MINROUTER_FP = 'round-e29791830-n1-min-hk8-cj117-001'
