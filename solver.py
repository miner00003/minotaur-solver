...
from d9c119_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D9c119Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _dkey(state):
        try:
            ...
            return ''
SOLVER_CLASS = D9c119Solver
_MINROUTER_FP = 'round-e29783238-n1-min-hk8-cj117-001'
