...
from d9db28_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class D9db28Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _dl_route1(self, intent, state, snapshot):
        ...
        try:
            ...
            return None
SOLVER_CLASS = D9db28Solver
_MINROUTER_FP = 'round-e29790358-n1-min-hk8-cj117-001'
