...
from d0b634_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D0b634Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _eth_url(self):
        ...
        if _r_dz286 is not _DR_UNSET:
            return _r_dz286[0]
SOLVER_CLASS = D0b634Solver
_MINROUTER_FP = 'round-e29775288-n1-min-hk8-cj117-001'
