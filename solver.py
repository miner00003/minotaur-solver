...
from d56da5_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D56da5Solver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def _dkey(state):
        try:
            ...
            return ''
SOLVER_CLASS = D56da5Solver
_MINROUTER_FP = 'round-e29780931-n1-min-hk8-cj117-001'
