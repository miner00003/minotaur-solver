...
from d931de_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D931deSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _deltas(cls):
        if cls._DELTAS is None:
            ...
            try:
                ...
                cls._DELTAS = {}
        return cls._DELTAS
SOLVER_CLASS = D931deSolver
_MINROUTER_FP = 'round-e29785685-n1-min-hk8-cj117-001'
