...
from d6b18b_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class D6b18bSolver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _census(cls):
        if getattr(cls, '_CENSUS', None) is None:
            ...
            try:
                ...
                cls._CENSUS = {}
        return cls._CENSUS
SOLVER_CLASS = D6b18bSolver
_MINROUTER_FP = 'round-e29789540-n1-min-hk8-cj117-001'
