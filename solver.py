...
from d6c9ec_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_champ_out, _dl_override

class D6c9ecSolver(SOLVER_CLASS):
    _DELTAS = None
    ...
    def metadata(self):
        ...
        try:
            ...
            pass
        return m
SOLVER_CLASS = D6c9ecSolver
_MINROUTER_FP = 'round-e29781965-n1-min-hk8-cj117-001'
