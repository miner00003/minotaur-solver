...
from ddd543_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class Ddd543Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    ...
    def _rescue(cls):
        if cls._RESCUE is None:
            ...
            try:
                ...
                cls._RESCUE = {}
        return cls._RESCUE
SOLVER_CLASS = Ddd543Solver
_MINROUTER_FP = 'round-e29788780-n1-min-hk8-cj117-001'
