...
from d35641_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix, _dl_base_ix, _BASE_MAJ, _dl_hub_defer_decide, _dl_census_ix, _dl_census_cover_impl, _dl_base_serve_impl

class D35641Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
    ...
    def _dl_snapshot_route(self, snapshot, tin, tout):
        ...
        for _addr, st in ps.items():
            try:
                ...
                continue
        return best
SOLVER_CLASS = D35641Solver
_MINROUTER_FP = 'round-e29794001-n1-min-hk8-cj117-001'
