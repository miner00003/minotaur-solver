...
from d10473_router import _dl_os, _dl_json, _DLPlan, _DLIx, _ETH_MAJ, _dl_eth_ix

class D10473Solver(SOLVER_CLASS):
    _DELTAS = None
    _RESCUE = None
    _OVR = None
    ...
    def _dl_census_cover(self, intent, state, rp, tin, tout, amt):
        ...
        try:
            ...
            pass
        return None
SOLVER_CLASS = D10473Solver
_MINROUTER_FP = 'round-e29793739-n1-min-hk8-cj117-001'
