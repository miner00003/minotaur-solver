...
def _mk_meta():
    return (os.environ.get('MINOTAUR_SOLVER_NAME', "leanrtr"), os.environ.get('MINOTAUR_SOLVER_VERSION', '3.37.0'), os.environ.get('MINOTAUR_SOLVER_AUTHOR', "randy707"))
...
try:
    ...
    def _m3c1_stamp(p, oh):
        ...
        try:
            ...
            pass
        return p
    _M3C1_SOLVER_NAME = os.environ.get('MINOTAUR_SOLVER_NAME', "leanrtr")
    ...
    try:
        ...
        def _m3ac1_stamp(p, oh):
            ...
            try:
                ...
                pass
            return p
        _M3AC1_SOLVER_NAME = os.environ.get('MINOTAUR_SOLVER_NAME', "leanrtr")
