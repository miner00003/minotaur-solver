...
try:
    ...
    def _dr13():
        ...
        try:
            ...
            def _putty_ck(a):
                return a
        _PUTTY_APPROVE_SEL, _PUTTY_BASE_CHAIN, _PUTTY_DEADLINE, _PUTTY_EXACT_IN_SINGLE_SEL, _PUTTY_PAIR_SWAP_SEL, _PUTTY_TRANSFER_SEL, _PUTTY_USDC, _PUTTY_WETH, _putty_log = _dz69()
